...
var appRoutes = [
    { path: '', component: _component_home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"] },
    ...
    { path: 'dashboard', component: _component_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'profile', component: _component_profile_profile_component__WEBPACK_IMPORTED_MODULE_12__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_15__["ValidateService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"], _services_auth_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"]],
...
/* harmony import */ var _services_show_msg_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/show-msg.service */ "./src/app/services/show-msg.service.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_storage_handle_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/storage-handle.service */ "./src/app/services/storage-handle.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(validateService, showMsgService, authService, router, storageHandler) {
        this.validateService = validateService;
        this.showMsgService = showMsgService;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.loginUser(credential).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                _this.showMsgService.showMsg('Welcome! ' + data.user.name, 'success');
                _this.storageHandler.setLocalStorage('user', data);
                _this.storageHandler.setLocalStorage('id_token', data.token);
                _this.authService.setUserAndAuthValue(data);
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.showMsgService.showMsg('Username / Password not valid');
                _this.authService.resetUserAndAuthValue();
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_validate_service__WEBPACK_IMPORTED_MODULE_2__["ValidateService"],
            _services_show_msg_service__WEBPACK_IMPORTED_MODULE_3__["ShowMsgService"],
            _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
            _services_storage_handle_service__WEBPACK_IMPORTED_MODULE_6__["StorageHandleService"]])
    ], LoginComponent);
...
/* harmony import */ var _services_show_msg_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/show-msg.service */ "./src/app/services/show-msg.service.ts");
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(router, authService, msgService) {
        this.router = router;
        this.authService = authService;
    ...
    NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _services_show_msg_service__WEBPACK_IMPORTED_MODULE_4__["ShowMsgService"]])
    ], NavbarComponent);
...
module.exports = "<h2 class=\"page-header\">Register</h2><br/>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label>Name</label>\n    <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\">    \n  </div>\n  <div class=\"form-group\">\n    <label>Username</label>\n    <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\">    \n  </div>\n  <div class=\"form-group\">\n    <label>Email</label>\n    <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\">    \n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\">    \n  </div>\n  <input type=\"submit\" name=\"submit\" id=\"submit\" class=\"btn btn-primary\" value=\"submit\">\n</form>"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, showMsgService, authService, router) {
        this.validateService = validateService;
        this.showMsgService = showMsgService;
        this.authService = authService;
        this.router = router;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            //console.log(data);
            if (data.success) {
                _this.showMsgService.showMsg('You are now registered and can login!', 'success');
                _this.router.navigate(['/login']);
            }
            else {
                _this.showMsgService.showMsg(data.msg || 'Something went wrong!');
...
/* harmony import */ var _storage_handle_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./storage-handle.service */ "./src/app/services/storage-handle.service.ts");
...
var AuthService = /** @class */ (function () {
    function AuthService(http, storageHandler) {
        this.http = http;
        this.storageHandler = storageHandler;
        this.jwtHelper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_5__["JwtHelperService"]();
        this.envioronment = 'SANDBOX'; //'DEVELOPMENT'; // 'DEVELOPMENT' -> While you develope in locally & 'PRODUCTION' -> When want to deploy to server;
    }
    // Register service
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post(this.envioronment == 'DEVELOPMENT' ? 'http://localhost:3000/users/register' : 'users/register', user, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return data; }));
    };
    // Login User Service
    AuthService.prototype.loginUser = function (cred) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.envioronment == 'DEVELOPMENT' ? 'http://localhost:3000/users/authenticate' : 'users/authenticate', cred, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return data; }));
    };
    // Get Profile
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.get(this.envioronment == 'DEVELOPMENT' ? 'http://localhost:3000/users/profile' : 'users/profile', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return data; }));
    };
    AuthService.prototype.logoutUser = function () {
        this.loadToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Authorization': this.authToken, 'Content-Type': 'application/json' });
        return this.http.get(this.envioronment == 'DEVELOPMENT' ? 'http://localhost:3000/users/logout' : 'users/logout', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) { return data; }));
    };
    ...
    AuthService.prototype.setUserAndAuthValue = function (data) {
        if (data.token) {
    ...
    AuthService.prototype.resetUserAndAuthValue = function () {
        this.authToken = null;
        this.user = null;
    };
    // Logout function
    AuthService.prototype.logout = function () {
        ...
        this.logoutUser().subscribe(function (data) {
            console.log(data);
            _this.resetUserAndAuthValue();
            _this.storageHandler.clearAllDataFromLocalStorage();
        });
    };
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"],
            _storage_handle_service__WEBPACK_IMPORTED_MODULE_4__["StorageHandleService"]])
    ], AuthService);
    return AuthService;
}());
...
/***/ "./src/app/services/show-msg.service.ts":
/*!**********************************************!*\
  !*** ./src/app/services/show-msg.service.ts ***!
  \**********************************************/
/*! exports provided: ShowMsgService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShowMsgService", function() { return ShowMsgService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ShowMsgService = /** @class */ (function () {
    function ShowMsgService(ngFlashMessageService) {
        this.ngFlashMessageService = ngFlashMessageService;
    }
    ShowMsgService.prototype.showMsg = function (msg, type) {
    ...
    ShowMsgService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
...
/***/ "./src/app/services/storage-handle.service.ts":
/*!****************************************************!*\
  !*** ./src/app/services/storage-handle.service.ts ***!
  \****************************************************/
/*! exports provided: StorageHandleService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StorageHandleService", function() { return StorageHandleService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var StorageHandleService = /** @class */ (function () {
    function StorageHandleService() {
    }
    // Set data to Local Storage
    StorageHandleService.prototype.setLocalStorage = function (uniqueName, data) {
        if (uniqueName && data) {
    ...
    StorageHandleService.prototype.getLocalStorage = function (uniqueName) {
        if (uniqueName) {
    ...
    // Remove Data
    StorageHandleService.prototype.removeLocalStorage = function (uniqueName) {
        if (uniqueName) {
    ...
    StorageHandleService.prototype.clearAllDataFromLocalStorage = function () {
        window.localStorage.clear();
    };
    StorageHandleService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], StorageHandleService);
    return StorageHandleService;
}());
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateUserCred = function (cred) {
...
module.exports = __webpack_require__(/*! C:\My_Goals_2019\MEAN\MEAN by Traversy Media\meanAuthApp\angular-src\src\main.ts */"./src/main.ts");
